...
namespace Koalamon\Bundle\Bundle\InformationBundle\Entity;
...
class Information
{
     ...
     * @var Project
     *
     * @ORM\ManyToOne(targetEntity="Koalamon\Bundle\IncidentDashboardBundle\Entity\Project", inversedBy="informations")
